<!-- PAGINA PER GESTIONE DEI PROPRI TEAM --> 
...
<body class="main_body">
    ...
    <header>
        ...
        <nav class="main-nav">
            <ul>
                <li>
                <?php 
                       echo' <a href="nuovo_team.php">CREA</a>';
                    ?>
                </li>
                <li>
                <?php 
                       echo' <a href="modifica_roster.php">MODIFICA</a>';
                    ?>
                </li>
    ...
    <div class="corpo-centrale">
        ...
        <div class="corpo-centrale2">
                        ...
                        $sql = "SELECT U.nomeUtente, C.nomeLega, C.nome AS squadra, C.puntiFatti, C.money
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = mysqli_fetch_array($result)) {
                                    ...
                                    <td><a title="MODIFICA LEGA"  href="../lega/lega.php">'.$row['nomeLega'].'</a></td>
                                    <td><a title="DETTAGLI FORMAZIONE" class="click_me" id="team'.$count.'" onclick="showRoster(this.id); showRiserve(this.id)">'.$row['squadra'].' </a></td>
            ...
            <div title="TITOLARI" id="getFormazione" class="formazione">
                <table>
        ...
        <aside class="aside-classifica">
            ...
            <table title="RISERVE" id="getRiserve" class="table-classifica">
            <thead>
                ...
                <tbody id="riserve">
                            ...
                            <tr id="row">
                                <?php
                                    echo "
                                        <td  colspan=\"2\">SELEZIONA UN TEAM</td>
                                    ";          
                                 ?>
                            </tr>
